...
class JsonToXlsxCommand extends AbstractInstallCommand
{
  protected static $defaultName = 'convert:json:xlsx';
  ...
  protected function execute(InputInterface $input, OutputInterface $output)
  {
    ...
    array_unshift($rows, array_keys($headers));
    $spreadsheet = new Spreadsheet();
    $spreadsheet->getActiveSheet()->fromArray($rows);

    ArrayUtility::write($spreadsheet, $outputPath);
